  ...
  return (
    <section className="relative min-h-[100vh] flex flex-col items-center justify-center overflow-hidden py-20 px-4">
      ...
      <div className="pointer-events-none absolute inset-0 z-0">
        {[
          { className: "left-10 top-20 w-96 h-96", bg: "from-zinc-800/50 to-zinc-800/30", blur: "blur-3xl" },
          { className: "right-16 bottom-16 w-80 h-80", bg: "from-zinc-600/40 to-zinc-600/20", blur: "blur-3xl" },
          { className: "left-1/3 top-1/3 w-72 h-72", bg: "from-zinc-500/30 to-zinc-700/20", blur: "blur-3xl" },
          { className: "right-1/4 top-20 w-64 h-64", bg: "from-zinc-500/40 to-zinc-700/10", blur: "blur-2xl" },
        ].map((b, i) => (
          <div
      ...
      <div ref={headerRef} className="relative z-10 text-center mb-16">
        <h2 className="text-4xl md:text-5xl font-extrabold text-zinc-200 tracking-tight mb-4">
          Simple, <span className="text-zinc-200">Transp</span><span className="text-blue-400">arent Pricing</span>
        </h2>
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl w-full px-4 ">
        {pricingPlans.map((plan, i) => (
          ...
          >
            ...
            {plan.popular && (
              <div className="absolute top-0 right-0 bg-zinc-500 text-white text-xs font-bold px-4 py-1.5 rounded-bl-xl z-10">
                MOST POPULAR
              </div>
            )}
            ...
            <div className={` p-8`}>
              ...
              <div className="flex items-baseline mb-8">
                ...
                <span className="text-lg text-zinc-300 ml-2">{plan.period}</span>
              </div>
                ...
                {plan.features.map((feature, idx) => (
                  <li key={idx} className="flex items-start gap-3">
                    ...
                    `}>
                      <Check 
                        size={14} 
                        className={plan.popular ? "text-green-400" : "text-green-400"}
                      />
                    </div>
