...
export const HowItWorks = () => {
  ...
  const macRefs = [useRef<HTMLDivElement | null>(null), useRef<HTMLDivElement | null>(null)];
  ...
  return (
    <section className="relative min-h-[100vh] flex flex-col items-center justify-center overflow-hidden">
        ...
        {[
          { className: "left-8 top-8 w-100 h-100", bg: "from-zinc-800/50 to-zinc-800/30", blur: "blur-3xl" },
          { className: "right-20 bottom-10 w-58 h-58", bg: "from-zinc-600/40 to-zinc-600/20", blur: "blur-3xl" },
          { className: "left-1/3 top-1/4 w-58 h-58", bg: "from-zinc-500/50 to-zinc-700/10", blur: "blur-2xl" },
          { className: "right-70 top-28 w-58 h-58", bg: "from-zinc-600/50 to-zinc-700/10", blur: "blur-3xl" },
          { className: "left-120 top-138 w-58 h-58", bg: "from-zinc-600/50 to-zinc-700/10", blur: "blur-3xl" },
        ...
        {videos.map((vid, idx) => (
          ...
          >
            ...
            <div className="w-full flex items-center px-4 py-[10px] bg-gradient-to-r from-zinc-700 to-zinc-900 rounded-t-2xl select-none">
              ...
              <span className="text-xs text-zinc-200 font-semibold tracking-wide">{vid.title}</span>
            </div>
