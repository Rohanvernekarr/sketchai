  ...
  const ApiDiagram1 = () => (
    <svg width="220" height="80" viewBox="0 0 120 60" fill="none">
      ...
      <path
        ...
        opacity="0.1"
      />
      <text x="22" y="35" fontSize="12" fill="#fff" opacity="0.5">
        API
      </text>
      <text x="78" y="35" fontSize="12" fill="#fff" opacity="0.5">
        Client
      </text>
      <defs>
        <linearGradient
        ...
        {[
          {
            ...
            bg: "from-zinc-700/50 to-zinc-800/10",
            blur: "blur-2xl",
          },
          {
...
"
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        ...
        <Link href="/dashboard">
          <button className="px-8 py-3 text-lg font-bold rounded-2xl bg-zinc-900/75 hover:bg-zinc-950 cursor-pointer shadow-xl text-white border border-blue-400 hover:border-blue-500 transition backdrop-blur-md">
            Try Sketch.AI &rarr;
          </button>
        </Link>
      </div>
