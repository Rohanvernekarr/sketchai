  ...
  useEffect(() => {
    ...
    if (
      ...
      drawFreehandStroke(ctx, {
        id: "temp",
        points: drawingHook.currentStroke,
        color: strokeColor,
        strokeWidth,
      });
    }
    ...
    if (
      ...
      drawFreehandShape(
        ctx,
        drawingHook.currentShape.start,
        drawingHook.currentShape.current,
        activeTool,
        strokeColor,
        strokeWidth,
        props.fillColor,
    ...
    systemElements.forEach((element) => {
      ...
      const elementToRender = isConnecting
    ...
    <div ref={containerRef} className="w-full h-full relative bg-black">
      <canvas
        ...
        onMouseMove={mergeHandlers(
          drawingHook.eventHandlers.onMouseMove,
          elementsHook.eventHandlers.onMouseMove,
        )}
        onMouseUp={mergeHandlers(
          drawingHook.eventHandlers.onMouseUp,
          elementsHook.eventHandlers.onMouseUp,
        )}
